 ...
 *
 * Antes era una ventana propia; ahora es una pestaña de Fundamentos, que junta
 * las dos cosas que alguien necesita para leer el mapa: la metodologia y las
 * siglas de este proceso.
 */
...
export default function GlosarioPanel({ processId, onCambio }) {
